...
export default function RootLayout({
  ...
  return (
    ...
    >
      <head>
        <meta name='impact-site-verification' value='c3defd74-2f17-4837-9ffa-dfd4297a456c' />
        <meta name="impact-site-verification" content="c3defd74-2f17-4837-9ffa-dfd4297a456c" />
